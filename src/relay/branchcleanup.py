"""Delete a finished ticket's git branch as part of `relay retire`.

Local and remote feature branches accumulate because nothing prunes them once
a ticket finishes. `relay retire` is the lifecycle event that disposes of the
...
from relay.autoclose import GhError, parse_branch_name, parse_pr_url, pr_state
