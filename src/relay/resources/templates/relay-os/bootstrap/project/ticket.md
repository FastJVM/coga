...
Persistent launch shim for an interactive project-planning session.
...
This shim is stateless. It has no status and acquires no lock — every launch is
...
`relay-os/skills/bootstrap/project/SKILL.md` override exists. This shim routes
...
Don't add `status:` or `owner:` to this frontmatter. The shim is intentionally
