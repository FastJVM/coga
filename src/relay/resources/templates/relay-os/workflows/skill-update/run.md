...
description: One-step script workflow that updates clean imported Relay-managed skills into one reviewable PR.
steps:
  - name: update
    skills:
...
`relay skill update --all --pr --json`: every clean imported-skill update lands
