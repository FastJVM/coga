...
from relay.commands import mv as mv_cmd
...
_BUILTIN_COMMANDS = frozenset(
    {
        ...
        "automerge", "delete", "mv", "draft", "retire", "panic", "slack",
        "digest", "skill", "mark", "recurring", "ticket", "project", "validate",
    }
)
