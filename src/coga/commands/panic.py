"""`coga panic` — agent is stuck, write blocker + notify owner."""
...
def panic(
    ...
    # still own the process, not after a supervising `coga launch` has begun
    ...
    # `coga launch` to tear down the agent's REPL. The non-zero exit
