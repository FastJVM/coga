...
then re-arm after the audit append. A failure before lifecycle publication
restores those generated bytes. If an interrupt lands only after both feature and control
publication succeeded, launch retains the identical published `in_progress`
