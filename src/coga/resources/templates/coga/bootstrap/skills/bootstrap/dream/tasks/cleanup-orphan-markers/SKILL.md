...
- `coga/tasks/<slug>/ticket.md` has exact `status: done`;
- the `ticket.md` blackboard region of `coga/tasks/<slug>/` has a `## Retro` block containing both
...
- no open PR is already touching `coga/tasks/<slug>/`;
