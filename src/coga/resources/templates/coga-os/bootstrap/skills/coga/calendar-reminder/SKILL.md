...
- Open `coga-os/tasks/<ticket-name>/ticket.md`
  (or `coga-os/recurring/<name>.md` if the artifact is a recurring
  entry, not a ticket).
...
|---|---|---|---|
| `coga-os/tasks/brex-automation/ticket.md` | `j3lt2meocjfetlbl6ga27jvvh8` | Monthly, 1st 9 AM PT | 2026-06-01 |
| `coga-os/tasks/xero-reconciliation/ticket.md` | `ns2of8i93mke579aedr927cv8k` | Monthly, 1st 9 AM PT | 2026-06-01 |
| `coga-os/recurring/gusto-tax-forms-download.md` | `0vhr5me50sbohsq9afo7jf85qg` | Yearly, Jan 5 9 AM PT | 2027-01-05 |
| `coga-os/tasks/insurance-payment-reminder/ticket.md` | `4jqgrfutdf6rctja3fo9kujrb0` | Yearly, May 1 9 AM PT | 2027-05-01 |
