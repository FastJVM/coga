...
This keeps task-state edits (`ticket.md`, plus the repo-global `coga-os/log.md`)
...
blackboard records *current* state, not history (that's the global `coga-os/log.md`'s
job).
