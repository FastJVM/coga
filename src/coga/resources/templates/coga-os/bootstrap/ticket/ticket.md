...
`coga-os/bootstrap/skills/bootstrap/ticket/SKILL.md` unless a local
`coga-os/skills/bootstrap/ticket/SKILL.md` override exists. This ticket routes bare
...
diverges from the canonical `coga-os/tasks/_template/ticket.md` shape.
