...
- **LLM launches require a TTY** → unattended drain depends on megalaunch, blockers, liveness limits, and `mode: script` work rather than a headless prompt flag.
