...
Assembles, in order: global rules → project context → ticket contexts
→ inline ticket context → current step skill → blackboard. Writes the
result to a temp file and returns the path.
