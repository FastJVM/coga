...
description: Scratch script skill for the auth-path manual test — prints which test_* Coga secret keys were injected into the script env, names only, never values.
script: probe.sh
---
