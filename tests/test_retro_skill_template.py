...
def test_retro_done_ticket_is_prompt_only_knowledge_extraction_skill() -> None:
    ...
    assert "read every context file under `coga-os/contexts/**/SKILL.md` and" in text
    assert "`coga-os/bootstrap/contexts/**/SKILL.md`" in text
    assert "read every skill file under `coga-os/skills/**/SKILL.md` and" in text
    assert "`coga-os/bootstrap/skills/**/SKILL.md`" in text
