---
schedule: "0 9 * * *"
schedule_comment: "Every day at 9am — flush the spooled state-change events into one Slack digest"
title: "Daily digest"
# `mode: script` runs the flush directly with no agent: the workflow's one
